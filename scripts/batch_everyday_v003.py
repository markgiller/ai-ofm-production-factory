#!/usr/bin/env python3
"""
Batch generate ~300 everyday lifestyle photos using LoRA v003.
Diverse scenes, natural/imperfect lighting, authentic feel.

Usage:
    python scripts/batch_everyday_v003.py \
...
LORA_NAME = "lora_chara_v003.safetensors"
LORA_STRENGTH = 0.8
FORMAT = "4:5"
OUTPUT_DIR = Path("./explore_output/batch_everyday_v003")


def main():
    import argparse
    parser = argparse.ArgumentParser(description="Batch everyday photos with LoRA v003")
