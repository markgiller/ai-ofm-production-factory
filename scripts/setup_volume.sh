...
echo "============================================================"
echo ""
echo "  Image model — FLUX.1 Dev 12B (via HuggingFace, requires access token)"
echo "  Source: https://huggingface.co/black-forest-labs/FLUX.1-dev"
echo "  Note: For LoRA training, ai-toolkit downloads the model automatically."
echo "  For ComfyUI inference, use fp8 quantized version:"
echo ""
echo "  # FLUX.1 Dev fp8 for ComfyUI inference"
echo "  wget -O ${VOLUME_PATH}/models/diffusion_models/flux1-dev-fp8.safetensors \\"
echo "    \"https://huggingface.co/Comfy-Org/flux1-dev/resolve/main/flux1-dev-fp8.safetensors\""
echo ""
echo "  # T5-XXL text encoder (fp8)"
echo "  wget -O ${VOLUME_PATH}/models/text_encoders/t5xxl_fp8_e4m3fn.safetensors \\"
echo "    \"https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/t5xxl_fp8_e4m3fn.safetensors\""
echo ""
echo "  # CLIP-L text encoder"
echo "  wget -O ${VOLUME_PATH}/models/clip/clip_l.safetensors \\"
echo "    \"https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/clip_l.safetensors\""
echo ""
echo "  # FLUX VAE"
echo "  wget -O ${VOLUME_PATH}/models/vae/ae.safetensors \\"
echo "    \"https://huggingface.co/black-forest-labs/FLUX.1-dev/resolve/main/ae.safetensors\""
echo ""
